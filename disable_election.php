...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $querystr = "UPDATE election SET enabled=0 WHERE id=" . $record_id . "";
    echo $querystr . "\n";
...
<body>
    ...
    <h1>Confirm DISABLE of this election? (will be disabled if already enabled)</h1>
    Election name:
    <?php print $election_name; ?> <br>
    Current status:
    <?php echo $election_curr_status; ?> <br>
    <form action="disable_election.php" method="post">
        <input type="hidden" name="record_id" value=<?php echo "\"" . $id . "\""; ?> >
        <input type="submit" name="Submit" value="Confirm Disable"/><br>
    </form>
</body>
</html>