    ...
    <div class="container">
        ...
        <table class="table" style="border-collapse:collapse; font-family: Arial;">
            <thead align="center">
                ...
                <th><strong>Election Ongoing?</strong></th>
            ...
            <?php
                if($row["enabled"] == 0){
                    echo '<a href="enable_election.php?id=' . $row["id"] . '">Enable Election</a>';
                }else{
                    echo '<a href="disable_election.php?id=' . $row["id"] . '">Disable Election</a>';
                }
            ?>
            </td>
            </tr>
